            ...
            Row(
                ...
                Column {
                    ...
                    Row(
                        ...
                        Icon(
                            imageVector = if (receipt.isSynced) Icons.Filled.CloudDone else Icons.Filled.CloudQueue,
                            contentDescription = if (receipt.isSynced) "Synced" else "Pending Sync",
                            tint = if (receipt.isSynced)
